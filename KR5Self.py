...
#􀰂􀰂􀰂􀰂[數]KR-02☪ইद
ks = LINETCR.LINE()
ks.login(token="Eo8ml4kgVBqCN6xiwtAc.HAXaYczGV0xVj7BkGgemFa.s9CHWe09mVvsGe+oYpT++sxKLA+xaeNs3QkR0RI4/Hw=")
ks.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-03☪ইद
kt = LINETCR.LINE()
kt.login(token=" Eo25iUUpFtcSM1Nlp5y6.OsmTA4zIXh1LxjgYbUWI9G.98xQ18RrJfNMDEMy6+Ul+0rHwek7PbqQPKh8YXDIC1g=")
kt.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-04☪ইद
kk = LINETCR.LINE()
kk.login(token="EoEn5rjls1wIsEFby57a.DHeHozIH2dDZH7qBMF5JwG.NkF00Qa3Wkgfy3gWhpiJgSrW1w66IYqc8hoZ55nQoY4=")
kk.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-05☪ইद
kc = LINETCR.LINE()
kc.login(token="EoqtuH5IjWZa6rMbSowd.nklCz8zx3nMDjSP4IRl1Fq.0gzS9w9CbKeANGJgiBpIkZizV0MjfhU6AYbnUcdhPes=")
kc.loginResult()
#Kicker-01#
kl = LINETCR.LINE()
kl.login(token="EoqbAfuSagP6TIwE3H9a.FJejU2LAd9gmRvON0u7DAG.c/9q4uEN/lgsRXYk48aRCgBZ4veIVAtkxKPSKxfGc3A=")
kl.loginResult()
#Kicker-02#
#kl1 = LINETCR.LINE()
#kl1.login(token="EoqbAfuSagP6TIwE3H9a.FJejU2LAd9gmRvON0u7DAG.c/9q4uEN/lgsRXYk48aRCgBZ4veIVAtkxKPSKxfGc3A=")
#kl1.loginResult()
#Kicker-03#
#kl2 = LINETCR.LINE()
...
●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
"""
KAC=[cl,ki,kk,kc,ks,kt,kl kl1,kl3]
