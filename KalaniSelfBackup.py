...
ks.login(token="Eopt3f9lHVUicT7damJc.y+2srPC7vfACLUdN4E1uda.uFIP3mO23GdlqNvhm/iSczzovNP2wdPPF6gKMaBsQAg=")
ks.loginResult()
...
nl1.login(token="EoTe5rjObbDN1tbNRDH4.KAsNdKGLcDtn8C5o10MlXa.HKTT4DSpaeP5nMRALujyZF8uFA7J4UlzEv56f1Lj0Ms=")
nl1.loginResult()
            ...
            if ki.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  ks.sendText(op.param1,cl.getContact(op.param2).displayName + "\n" + "We Enter Into Blacklist Bebs Done✔")
