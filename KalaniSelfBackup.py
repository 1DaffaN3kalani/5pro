...
nl.login(token="EoH6XisVR40syMB9cVT9.8ccvTR8aHloLYcm86rZIEq.m+9YWImCpLYFCxUe0s9Z4Ww4XF5rtokT2BF0SE/UzXA=")
nl.loginResult()
...
admin=["u0f4cbccff2b03754d07d8db8707023f6","u152d821a1971eada3271af3d33c942b1","u8b0786be72edafd53a9ce1a693e834b2","u49f0e82e090055efa3a43330be526467","uf02095b6bf0084b3a5c8233ce91ce279"] 
            ...
            if ki.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  random.choice(KAC).updateGroup(G)
                  random.choice(KAC).sendText(op.param1,ks.getContact(op.param2).displayName + "\n" + "We Enter Into Blacklist Bebs")
              ...
              if msg.from_ in owner:
                ...
                for target in targets:
                   try:
                       ...
                       nl.leaveGroup(msg.to)
                       gs.preventJoinByTicket = True
                       random.choice(KAC).uldateGroup(gs)
