...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,mid1,mid2]
admin=["u0f4cbccff2b03754d07d8db8707023f6",Amid,Bmid,Cmid,Dmid,Emid,"u152d821a1971eada3271af3d33c942b1","u8b0786be72edafd53a9ce1a693e834b2","u49f0e82e090055efa3a43330be526467","uf02095b6bf0084b3a5c8233ce91ce279"] 
owner=["u0f4cbccff2b03754d07d8db8707023f6",Amid,Bmid,Cmid,Dmid,Emid]
            ...
            if random.choice(KAC).getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 not in admin:
                try:
                  ...
                  random.choice(Kicker).acceptGroupInvitationByTicket(op.param1,Ticket)
                  time.sleep(0.00001)
                  random.choice(Kicker).kickoutFromGroup(op.param1,[op.param2])
                  random.choice(Kicker).leaveGroup(op.param1)
            ...
            if op.param3 in mid:
              if op.param2 not in Bots or owner:
                try:
                  ...
                  time.sleep(0.00001)
                  random.choice(Kicker).kickoutFromGroup(op.param1,[op.param2])
                  H = random.choice(Kicker).getGroup(op.param1)
                  H.preventJoinByTicket = False
                  random.choice(Kicker).updateGroup(H)
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Kick User Target Finish----------------------#      
              ...
              if msg.from_ in owner:
                ...
                invsend = 0
                Ticket = cl.reissueGroupTicket(msg.to)
                random.choice(Kicker).acceptGroupInvitationByTicket(msg.to,Ticket)
                time.sleep(0.2)
                targets = []
                key = eval(msg.contentMetadata["MENTION"])
                key["MENTIONEES"] [0] ["M"]
                ...
                for target in targets:
                   try:
                       ...
                       random.choice(Kicker).leaveGroup(msg.to)
                       gs = cl.getGroup(msg.to)
                       gs.preventJoinByTicket = True
                       cl.updateGroup(gs)
                       print (msg.to,[g.mid])
                   except:
                       random.choice(Kicker).sendText(msg.to,"Done See U  Bye Bye....")
                       random.choice(Kicker).leaveGroup(msg.to)
                       gs = cl.getGroup(msg.to)
                       gs.preventJoinByTicket = True
                       cl.uldateGroup(gs)
