...
ka.login(token="Eo6pcEZ2XZagEAnL0GD3.L9pMQX2GdfKTYct2VR4V8W.sn8y6hiTFNip72ymBi9JFs4ebJGwfm5soU+9ilDbDV4=")
ka.loginResult()

k1 = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-Backup☪ইद 􀂳􏿿
k1.login(token="EonDRkxZthYZ41Z4NcT1.fs2cgHLX6TOYCA89m8LcSq.xTIHylhstn16WbvmMLVhlQccSyv7N2Hl3pne3L+fU20=")
k1.loginResult()
...
Amid = ki.getProfile().mid#One
Bmid = kk.getProfile().mid#Two
Cmid = kc.getProfile().mid#Tree
Dmid = ks.getProfile().mid#Four
Emid = ka.getProfile().mid#Five
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"THANKS FOR ADD ME SORRY IAM JUST BOT ^_^",
    "lang":"JP",
    "comment":"Thanks for add Me ^_^",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
