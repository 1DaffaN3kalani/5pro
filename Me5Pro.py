...
#􀰂􀰂􀰂􀰂[數]Kalani☪ইद 􀂳􏿿
cl = LINETCR.LINE()
cl.login(token="Epmr4c5IZWWxtZcBBod1.fs2cgHLX6TOYCA89m8LcSq.zMcJAo42xVRpKJBKDRnbJEIjpugwaxiLNGaOTDLXRlE=")
cl.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-01☪ইद
ki = LINETCR.LINE()
ki.login(token="EpRVb9UvJQXHL5wAyJQ2.IWEgVNlTR9u6NogMK/G0SG.foWjYntcds0Dsf4PDZsDybgNbBrywWMg9egSCMmgqZw=")
ki.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-02☪ইद
kk = LINETCR.LINE()
kk.login(token="EpYpHiQAZ4fUfSMbOmb7.sFdOlGKavE/JPdmWVLjKzW.xQogeGQZrePmX5bO7wpPlR7xk3n7n1SDFbK99Z11sw8=")
kk.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-03☪ইद
kc = LINETCR.LINE()
kc.login(token="EpGSXqO9Sdz2xnYIO1U9.8ccvTR8aHloLYcm86rZIEq.VKD6SfjagDad0EbjZbwt2cQbKvncoRW815B+m7uthxI=")
kc.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-04☪ইद
ks = LINETCR.LINE()
ks.login(token="Ep7XRiCiUAPwBQOI8pf3.PkKNsTykUChFu4RWKDTN0W.HMaHtzEPxuIdlt6urmRIkNtxD1VoIeqXzAhxsZoqz2o=")
ks.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-05☪ইद
kt = LINETCR.LINE()
kt.login(token="Ep0mttmUI1F52Cqz7EZ4.KAsNdKGLcDtn8C5o10MlXa.Zsib7XTB/2u9YR8jUSN9YbNtk4UN1yxODoDRBHoWzLU=")
kt.loginResult()
#Kicker-01#
kl = LINETCR.LINE()
kl.login(token="Ephs0oyZhbOTdExG0I81.cnCKeS8mJyEU5JSZppFleq.q6NG993aKVNXnuewo+iV0wvQlYKR/8B7ZTV/W9vpZuE=")
kl.loginResult()
#Kicker-02#
#kl1 = LINETCR.LINE()
