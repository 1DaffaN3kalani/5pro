...
cl = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]Kalani☪ইद 􀂳􏿿
cl.login(token="Eo0kXalWC6jXpdIC9rW6.d0Y8Z+kWn1tqFy24ChaJ9G.Yohyb0oYslwES9hGvb7TH8qLWrIasF1rMo/UZzqpmcs=")
cl.loginResult()

ki = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-01☪ইद 􀂳􏿿
ki.login(token="EoJsv1L5uxzl5GiNXaW7.ydbWO6RI0lXwb5cAALoMfW.m+9eamXAR7zhkgGoTd+UwhEPwd624REap7uHXNqA15Y=")
ki.loginResult()

kk = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-02☪ইद 􀂳􏿿
kk.login(token="EoXJDGquUdItGM84qXN6.xp+F+955ZJ52/D+jPSnjHG.e7wgr7xvwreTU/1zmO6ee0QKVPAodsT4TW7YJ+YLUYQ=")
kk.loginResult()

kc = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-03☪ইद 􀂳􏿿
kc.login(token="EoV7hbDhp52DWM31zfg2.6qP7wxDr/icxSov6HIJlOG.gwbMGoOyr4azS4H/m7Vzeau9AbnhsHUIzuUPPEzrFcU=")
kc.loginResult()

ks = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-04☪ইद 􀂳􏿿
ks.login(token="EodoDGQkEWvcXX32HiJ2.dgYWt8es393tPMWTlHCRaG.KPPNhfyAqQ6QuFSDk2Dj/QidUzics1k53TFmzWBeaJg=")
ks.loginResult()

ka = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-05☪ইद 􀂳􏿿
ka.login(token="Eot8cBWdWFRNmPOqHcac.9JCC6XNULINI3/Azqfajxa.WFMVtH8RwTRNuBgiYw631uPXencxCtyzB3I6+w1TjdA=")
ka.loginResult()

nl = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-Kickers☪ইद 􀂳􏿿
nl.login(token="EoDTY8KuR6skzQ3PRgLa.t66I99EO5cPBxKdClBrhYG.qG4cWDtG07VPhJWrcBOVJSvIq7SVmh73M737lGZsBKc=")
nl.loginResult()

print "KR1Self5Bot1Kickers-T34M SUCCES"
reload(sys)
...
║[★]Anu [Tag]
║[★]Gn [Nama Group]
║[★]Bot1~5 gn [Nama Group]
║[★]All contact [Contact Bot]
║[★]My mid
║[★]Mid Bot
║[★]Me (Cek Mid)
║[★]Gcreator
...
║[★]Runtime
║[★]Combat [Kickers]
║[★]Cipok/Pancal/Sosor @[Tag]
║[★]Pancal1 @[Tag]
║[★]Unban [Share contact]
║[★]List Group/LG
║[★]LG1/LG2/LG3/LG4
║[★]Invite [Share contact]
║[★]1~3Invite [Share contact]
...
●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
"""
KAC=[cl,ki,kk,kc,ks,ka,nl]
KAB=[ki,kk,kc,ks,ka]
mid = cl.getProfile().mid#Kalani
Amid = ki.getProfile().mid#數]KR-01☪ইद 􀂳􏿿
Bmid = kk.getProfile().mid#數]KR-02☪ইद 􀂳􏿿
Cmid = kc.getProfile().mid#數]KR-03☪ইद 􀂳􏿿
Dmid = ks.getProfile().mid#數]KR-04☪ইद 􀂳􏿿
Emid = ka.getProfile().mid#數]KR-05☪ইद 􀂳􏿿 􀂳􏿿
mid1 =nl.getProfile().mid#􀰂􀰂􀰂􀰂[數]KR-Kickers☪ইद 􀂳􏿿

Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,mid]
admin=[mid] 
owner=[mid]
whitelist=["u82f7bb98715417c34fe1b7fac263e893","u0f4cbccff2b03754d07d8db8707023f6"]
wait = {
    'contact':False,
    'autoJoin':True,
            ...
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 not in admin:
                try:
                  ...
                  random.choice(KAB).sendText(op.param1,ki.getContact(op.param2).displayName + "\n" + "We Enter Into Blacklist Bebs😘😘😘")
                  wait["blacklist"][op.param2] = True
                  f=codecs.open('st2__b.json','w','utf-8')
                  json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                except:
                  G = random.choice(KAB).getGroup(op.param1)
                  G.preventJoinByTicket = False
                  random.choice(KAB).updateGroup(G)
                  Ticket = random.choice(KAB).reissueGroupTicket(op.param1)
                  nl.acceptGroupInvitationByTicket(op.param1,Ticket)
                  nl.kickoutFromGroup(op.param1,[op.param2])
                  H = nl.getGroup(op.param1)
                  H.preventJoinByTicket = True
                  nl.updateGroup(H)
                  nl.leaveGroup(op.param1)
                  random.choice(KAB).sendText(op.param1,random.choice(KAB).getContact(op.param2).displayName + "\n" + "We Enter Into Blacklist Bebs😘😘😘")
                  wait["blacklist"][op.param2] = True
                  f=codecs.open('st2__b.json','w','utf-8')
                  json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
  ...
  #------Joined User Kick start------#
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.name = msg.text.replace("Bot gn ","")
                    ki.updateGroup(X)
                else:
              ...
              if msg.from_ in owner:
                midd = msg.text.replace("Bot1 nvite ","")
    ...
    #--------------= SC Ganti nama Owner=--------------
              ...
              if msg.from_ in owner:
                if wait["detect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already On Bebs 😘😘💋💋 Done ✔")
                    else:
                        cl.sendText(msg.to,"Tag On Bebs 😘😘💋💋 Done✔")
                else:
                    wait["detect"] = True
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Tag On Bebs 😘😘💋💋 Done✔")
                    else:
                        cl.sendText(msg.to,"already on 😘😘💋💋 Done ✔")
            elif msg.text in ["Tag off"]:
              if msg.from_ in owner:
                if wait["detect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Already off Bebs😘😘💋💋 Done✔")
                    else:
                        cl.sendText(msg.to,"Tag Off Bebs😘😘💋💋 Done✔")
                else:
                    wait["detect"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Tag Off Bebs😘😘💋💋 Done✔")
                        ...
                        cl.sendText(msg.to,"Already off Bebs😘😘💋💋Done✔")
  #-----------------=Selesai=------------------
            elif msg.text in ["Team","All contact","Bot contact"]:
              if msg.from_ in owner:
                msg.contentType = 13
            ...
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Spam gift"]:
              if msg.from_ in admin:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
            ...
            elif msg.text in ["æ„›ã�®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","Spam All gift"]:
              if msg.from_ in owner:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                                    'PRDTYPE': 'THEME',
            ...
            elif msg.text in ["Bot1 cancel","bot1 cancel"]:
              if msg.from_ in owner:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Bot2 close qr","bot2 tutup qr"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
            ...
            elif msg.text in ["Bot4 tutup qr","bot4 close qr"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
            ...
            elif msg.text in ["Cancel invite on","cancel invite on"]:
              if msg.from_ in owner:
                if wait["Protectcancel"] == True:
                  if wait["lang"] == "JP":
            ...
            elif msg.text in ["Cancel invite off","cancel invite off"]:
              if msg.from_ in owner:
              ...
              if msg.from_ in admin:
                md = "╔═══════════════\n║⭐Protection Status⭐\n║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓\n"
                if wait["Protectgr"] == True: md+="║[•]Protect QR [Off]\n"
                else: md+="║[•]Protect QR [On]\n"
              ...
              if msg.from_ in admin:
                gid = msg.text.replace("Abum remove ","")
...
#---------------------Sc invite owner ke group------
                ...
                wait2['ROM'][msg.to] = {}
                 ...
                 if msg.from_ in admin:
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Command 👉Cek Dulu Boss Next Command 👉Sider\nDasar Pikun Alias pelupa Lu Bebs😜😜😜♪")
        #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["KR2 in","Come","Oyyy","In"]:
              if msg.from_ in owner:
              ...
              if msg.from_ in owner:
                ...
                time.sleep(0.00001)
                G = nl.getGroup(msg.to)
                G.preventJoinByTicket = True
                nl.updateGroup(G)
                Ticket = nl.reissueGroupTicket(msg.to)
                
            elif msg.text in ["Kalani come"]:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye KR","Bye KR2","Bye","Bye bye"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Kicker bye","Bye kicker"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot all out group","KR all out","Bot all out"]:
              if msg.from_ in owner:
                #gid = cl.getGroupIdsJoined()
                gid = ki.getGroupIdsJoined()
                gid = kk.getGroupIdsJoined()
                ...
                for i in gid:
                  ...
                  kk.leaveGroup(i)
                if wait["lang"] == "JP":
                  cl.sendText(msg.to,"Bye....Bye....Sampai jumpa kawan2😘😘")
                else:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["KR stay","Respon","Stay"]:
              if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"すでに保護している86It's Present KR-R4D15T1 T34M Ready To Protect Group Bebs😘😘😘💋💋")
                
            elif msg.text in ["Kicker respon","Kicker stay"]:
              if msg.from_ in admin:
                nl.sendText(msg.to,"すでに保護している86(Already On Protect Group)")
            elif msg.text in ["Just spam"]:
              if msg.from_ in admin:
                #cl.sendText(msg.to,"すでに保護している86(Already On Protect Group)")
                cl.sendText(msg.to,"")
                ki.sendText(msg.to,"")
                kk.sendText(msg.to,"")
                kc.sendText(msg.to,"")
                ks.sendText(msg.to,"")
                ka.sendText(msg.to,"")
                cl.sendText(msg.to,"")
                ki.sendText(msg.to,"")
                kk.sendText(msg.to,"")
                kc.sendText(msg.to,"")
                ...
                ks.sendText(msg.to,"")
                ka.sendText(msg.to,"")
                cl.sendText(msg.to,"🙏🙏🙏🙏🙏😁😁😁😁")
    #-------------Fungsi Respon Finish---------------------#   
      ...
      #-------------Fungsi Balesan Respon Start---------------------#
                ...
                random.choice(KAC).sendText(msg.to,"Apaan sih Panggil2👊👊👊Naksir ya???,Pm aja X gak usah panggil2 mulu Dasar kurang Anu ya!!!😜😜😜")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            ...
            elif msg.text in ["Speed5","Sp5"]:
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Progress▒▒▒▓▓▓LOAD...99%")
                elapsed_time = time.time() - start
                ki.sendText(msg.to, "0.000222435466Seconds")
                kk.sendText(msg.to, "0.000222435466Seconds")
                kc.sendText(msg.to, "0.000222435466Seconds")
                ks.sendText(msg.to, "0.000222435466Seconds")
                kk.sendText(msg.to, "0.000222435466Seconds")
                
            elif msg.text in ["Speed1","Sp1"]:
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Progress▒▒▒▓▓▓LOAD...99%")
    ...
    #-------------Fungsi Bannlist Finish------------------#  
            ...
            elif "Tanslate-japan " in msg.text:
              if msg.from_ in admin:
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
            return
          cl.sendText(op.param1, "[ Bye Bye 🙋🙋 Broo Sampai jumpa kembali ]")
