...
nl = LINETCR.LINE()
nl.login(token="EoTgd7nANPmF7Rv7qyv1.cnCKeS8mJyEU5JSZppFleq.cZFbzld/wrX1+yNVQpvyQODYEOClEzu+6jdVzYzIbeA=")
nl.loginResult()
...
kick1 = nl.getProfile().mid
Bots = [mid,Amid,kimid,ki2mid,kick1]
administrator = [mid]
admin = [mid]
