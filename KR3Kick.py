...
kc.login(token="EoQqChiAklh8sZkIZ467.sFdOlGKavE/JPdmWVLjKzW.tXnO/vZZSN6K+ub2fhGi0uanWpfcN4/HMa0zhiE7Zdg=")
kc.loginResult()

#ks = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-04☪ইद 􀂳􏿿
#ks.login(token="EoH6XisVR40syMB9cVT9.8ccvTR8aHloLYcm86rZIEq.m+9YWImCpLYFCxUe0s9Z4Ww4XF5rtokT2BF0SE/UzXA=")
#ks.loginResult()

#ka = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-05☪ইद 􀂳􏿿
#ka.login(token="EozlKSPl22UcSObvw0N3.PkKNsTykUChFu4RWKDTN0W.0SmLe0IEpqHsmdNWBg6lFVT5g7JsLZRL9YwW3XSExfA=")
#ka.loginResult()

#kb = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-06☪ইद 􀂳􏿿
#kb.login(token="EoTe5rjObbDN1tbNRDH4.KAsNdKGLcDtn8C5o10MlXa.HKTT4DSpaeP5nMRALujyZF8uFA7J4UlzEv56f1Lj0Ms=")
#kb.loginResult()

#ko = LINETCR.LINE() #[數]KR-07☪ইद
#ko.login(token="EoVzHOMYIhko5QR0Z6O9.ZKUHmn7A7fy0TpGtw0PFQq.Svc7aK3BpIYtcf5AiY4Goto7hMMz1sbfcsQ85mx2zpo=")
#ko.loginResult()

#ke = LINETCR.LINE() #[數]KR-08☪ইद
#ke.login(token="EokLZi646ykBAqwuuzk3.+uLPvUiSMYLprcBKBSaDiW.pWSrF2Kqo553sRe2Z8oeYz/5jHM2d+dY8pjTNi0YV9Q=")
#ke.loginResult()

#ku = LINETCR.LINE() #[數]KR-09☪ইद
#ku.login(token="Eo6pcEZ2XZagEAnL0GD3.L9pMQX2GdfKTYct2VR4V8W.sn8y6hiTFNip72ymBi9JFs4ebJGwfm5soU+9ilDbDV4=")
#ku.loginResult()

#km = LINETCR.LINE() #[數]KR-10☪ইद
#km.login(token="Eopt3f9lHVUicT7damJc.y+2srPC7vfACLUdN4E1uda.uFIP3mO23GdlqNvhm/iSczzovNP2wdPPF6gKMaBsQAg=")
#km.loginResult()
...
Amid = ki.getProfile().mid#[數]KR-01☪ইद
Bmid = kk.getProfile().mid#[數]KR-02☪ইद
Cmid = kc.getProfile().mid#[數]KR-03☪ইद
#Dmid = ks.getProfile().mid#[數]KR-04☪ইद
#Emid = ka.getProfile().mid#[數]KR-05☪ইद
#Fmid = kb.getProfile().mid #[數]KR-06☪ইद
#Gmid = ko.getProfile().mid #[數]KR-07☪ইद
#Hmid = ke.getProfile().mid #[數]KR-08☪ইद
#Imid = ku.getProfile().mid #[數]KR-09☪ইद
#Jmid = ku.getProfile().mid #[數]KR-10☪ইद
...
Bots=[mid,Amid,Bmid,Cmid,mid1,mid2,mid3]
admin=[mid,Amid,Bmid,Cmid,mid1,mid2,mid3,"uf02095b6bf0084b3a5c8233ce91ce279","ua4a9274ad60ab9c1df538af091db67d3","u91a4a70e482509d4cdf1ce4ed7498bc4","uce4ba130dedaec5634b4f8135b4a5fa9","ufd496956e22c9b294f4426e46ec01d23","u97d3e6ab1da00c592dc824f6bebe2ff3","u63fd9246973b54569c96e0e7e1ed540c"] 
owner=[mid]
whitelist=["u82f7bb98715417c34fe1b7fac263e893","u7341e12330207e4e2425341323bb9c46","u05b001551c897ad6a6e2ca6cecccd32e","u152d821a1971eada3271af3d33c942b1"]
        ...
        if op.type == 13:
          if wait["Protectcancl"] == True:
            if wait["blacklist"][op.param3] == True:
              ...
              random.choice(KAB).cancelGroupInvitation(op.param1,[op.param3])
            else:
              pass
            ...
            if op.param2 not in Bots or admin:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  random.choice(KAB).cancelGroupInvitation(op.param1, gMembMids)
                  random.choice(KAB).sendText(op.param1,random.choice(KAB).getContact(op.param2).displayName + "\n" + "Who do you want to invite  ??? \nYou Are Not Our Admin, So We Cancel it.\nPlease Contact Admin/Owner")
                  random.choice(KAB).kickoutFromGroup(op.param1,[op.param2])
        ...
        if op.type == 17: #Protect Join
          if wait["Protectjoin"] == True:
            if wait["blacklist"][op.param2] == True:
              ki.sendText(op.param1,cl.getContact(op.param2).displayName + " On Blacklist Bebs\nWe Will Kick")
              random.choice(KAB).kickoutFromGroup(op.param1,[op.param2])
            ...
            if op.param3 in mid:
              ...
              if op.param2 not in Bots or owner:
                try:
                  ...
                  G = random.choice(KAB).getGroup(op.param1) #Sanji Bertindak
                  random.choice(KAB).kickoutFromGroup(op.param1,[op.param2])
                  G.preventJoinByTicket = False
                  random.choice(KAB).updateGroup(G)
                  Ticket = random.choice(KAB).reissueGroupTicket(op.param1)
              ...
              if msg.from_ in owner:
                if wait["detect"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Already off Bebs😘😘💋💋Done✔")
  #-----------------=Selesai=------------------
            elif msg.text in ["Team","All contact"]:
              if msg.from_ in owner:
                msg.contentType = 13
            ...
            elif "KR10 rename " in msg.text:
              if msg.from_ in owner:
                string = msg.text.replace("KR10 rename ","")
                if len(string.decode('utf-8')) <= 6000000000:
                    profile = ki.getProfile()
                    profile.displayName = string
                    ki.updateProfile(profile)
                    ki.sendText(msg.to,"name " + string + " done")
            elif "KR11 rename " in msg.text:
              if msg.from_ in owner:
                string = msg.text.replace("KR11 rename ","")
                if len(string.decode('utf-8')) <= 6000000000:
                    profile = kk.getProfile()
                    profile.displayName = string
                    kk.updateProfile(profile)
                    kk.sendText(msg.to,"name " + string + " done")
            elif "KR12 rename " in msg.text:
              if msg.from_ in owner:
                string = msg.text.replace("KR12 rename ","")
                if len(string.decode('utf-8')) <= 6000000000:
                    profile = kc.getProfile()
                    profile.displayName = string
                    kc.updateProfile(profile)
                    kc.sendText(msg.to,"name " + string + " done")
            elif "KR13 rename " in msg.text:
              if msg.from_ in owner:
                string = msg.text.replace("KR13 rename ","")
                if len(string.decode('utf-8')) <= 6000000000:
                    profile = ks.getProfile()
                    profile.displayName = string
                    ks.updateProfile(profile)
                    ks.sendText(msg.to,"name " + string + " done")
            elif "KR14 rename " in msg.text:
              if msg.from_ in owner:
                string = msg.text.replace("KR14 rename ","")
                if len(string.decode('utf-8')) <= 6000000000:
                    profile = ka.getProfile()
                    profile.displayName = string
                    ka.updateProfile(profile)
...
#---------------------Sc invite owner ke group------
        ...
        #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["KR2 in","/come","Oyyy","KR in"]:
              if msg.from_ in owner:
                ...
                time.sleep(0.00001)
                G = random.choice(KAB).getGroup(msg.to)
                G.preventJoinByTicket = True
                random.choice(KAB).updateGroup(G)
                print "R4D15T1 T34M Self Complete"
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye KR","Bye KR2","/out","Bye bye"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
            ...
            elif msg.text in ["Bye aku pamit dulu ya"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["KR2 all out","KR all out","Bot all out"]:
              if msg.from_ in owner:
                #gid = cl.getGroupIdsJoined()
                gid = ki.getGroupIdsJoined()
                gid = kk.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["KR stay","KR2 stay","Stay"]:
              if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"すでに保護している86It's Present KR2-T34M Ready To Protect Group Bebs😘😘😘💋💋")
                
            elif msg.text in ["Kicker stay."]:
              if msg.from_ in admin:
                nl.sendText(msg.to,"すでに保護している86(Already On Protect Group)")
                nl1.sendText(msg.to,"すでに保護している86(Already On Protect Group)")
                nl2.sendText(msg.to,"すでに保護している86(Already On Protect Group)")
                nl.sendText(msg.to,"すでに保護している86[We are always on standby outside the room]")
