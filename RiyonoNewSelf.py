...
cl.login(token="En6naQfTP7VFp8K9x7x6.fTKCLmFlBfpEHyAxbVypLG.Sll6bLcsd/cqT5hYwGDRfcY1WIbHrOZ2SRC84v2qFOs=")
cl.loginResult()

ki = LINETCR.LINE() #One
ki.login(token="En3OuNR2cfDxZqJ3oib6.NXd37ScSBDLnUL5NT3eDfG.MC35ZomsvIfvg/qN1WpnFmvcxblVnn98DOXXvm/HEe4=")
ki.loginResult()

kk = LINETCR.LINE() #Two
kk.login(token="EnxKM4NkFQFBHWOomJ66.l1sUJRZN2Plp7X7G+jey9G.zhP/hRFTAM1JuZ/SJ232QdPpc0oFdbfw0kK6T8gL5sM=")
kk.loginResult()

kc = LINETCR.LINE() #Tree
kc.login(token="Enpb2K9sbmQj4XW8gmUa.Dhdy2GKcCS4nNmLJCaNpcG.ZmrD1vQpw7wF99daTi0mSAnl83P+GFUuZGhIqXxCRS8=")
kc.loginResult()

ks = LINETCR.LINE() #Four
ks.login(token="EnHMtLd0IVfE6O3HGzG1.nqiomoBQHvZwTghGAbvWyq.V5+VGZoa+/7ExNOitfiV1satb3YhSCIEEBw/FtDhx+E=")
ks.loginResult()

ka = LINETCR.LINE() #Five
ka.login(token="EnfJT6vL9emuioy5bTH6.q3uM03cLP1Ka+2slGGx0DG.srXrAYwRtWWpZNeD0gkw5EehcLTeFtnYKxzvnV3+QpQ=")
ka.loginResult()
...
♨▶.instagram [text]
♨▶.wikipedia [text]
♨▶.music [penyanyi][judul lagu]
♨▶.lyric [penyanyi][judul lagu]
♨▶.youtube [judul youtube]
...
#---------------------Sc invite owner ke group------
        ...
        #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["iin","Masuk","Bot in"]:
              if msg.from_ in owner:
                ...
                G.preventJoinByTicket = True
                cl.updateGroup(G)
                print "Semua Sudah Lengkap boskuu"
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif "Zuzu" in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Zuzu","")
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
        ...
        #----------------Fungsi Unbanned User Target Finish-----------------------#
            elif "Ngopi @" in msg.text:
              if msg.from_ in owner:
                _name = msg.text.replace("Ngopi @","")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                targets = []
                for g in gs.members:
                ...
                if targets == []:
                  ...
                  for target in targets:
                    try:
                      ...
                      cl.sendText(msg.to, "Success Copy profile Boskuu~")
    ...
    #-------------Fungsi Respon Finish---------------------#   
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
              ...
              if msg.from_ in admin:
                start = time.time()
                cl.sendText(msg.to, "Ngopi sik boskuu...")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sSeconds jangan lupa Bahagia" % (elapsed_time))
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              cl.sendText(msg.to,"囧rz囧rz囧rz囧rz囧rz囧rz囧rz")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"囧rz囧rz囧rz囧rz囧rz囧rz囧rz")
              
            elif msg.text in ["Woy","woy","Woi","woi","bot","Bot"]:
              quote = ['Apaan sih Ka Kurang Kerjaan Banget','Call me kak','Aku kudu piye','Sabar kakak','Ada Orang kah disini?','Minum aqua kak kalau haus','Ada janda rasa perawan nggak kak']
