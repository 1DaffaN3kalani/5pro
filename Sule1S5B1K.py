...
cl.login(token="EoKbOnEuTv53HwAyzrka.rhqZctF4XyggQSVpk9tpAG.4S8KFuNp1J6HXugd+LR1gV5R9hsQsNZ38kpnlBKL9R0=")
cl.loginResult()

ki = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-01☪ইद 􀂳􏿿
ki.login(token="EoFs43utD4GcS3CfOA08.XThgVUAsOxxldrveqFlcUa.flCSCrLYf/CU1/C5Z2XP3+bouYeA+B4/xyv43IgqJ0A=")
ki.loginResult()

kk = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-02☪ইद 􀂳􏿿
kk.login(token="EoCzuZezOYkf9pdMZw46.UiTktPoYnDyrRNHwfgtKHG.uWbpM/uB6/6F0BT8gtoDAc/j7y3ypUIk5OOASabA1hY=")
kk.loginResult()

kc = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-03☪ইद 􀂳􏿿
kc.login(token="Eoke8S3x711QjQSIEDA6.Mf6Y0hhMBXyPbowWi1/lbG.BsiSWIO9CaQlbBK6nOjpQTLqyW94KxjyDzOFJMlSPF0=")
kc.loginResult()

ks = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-04☪ইद 􀂳􏿿
ks.login(token="Eo2EzYvNL1nSjYRmO4w4.8P4cJNlDEGjr5rkrcLb2ja.ZZbyEG2bKFdGpdtq5hyvbuocZIW1+7rXxYUpB7FPAb8=")
ks.loginResult()

ka = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-05☪ইद 􀂳􏿿
ka.login(token="EoYls2ZGSNbVZWfEpFfc.k/6nVw5DVCc57pI1IwtrJa.CxApNkbn4cvb8/1O25R8EIUFL/QTx15z5vISj7NLj4c=")
ka.loginResult()

nl = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-Kickers☪ইद 􀂳􏿿
nl.login(token="EomzxOYqrsM344ezjUq4.uJVWltoITIU3ziYeUQTHXa.qz/8b9nZTmf5RfbuzkIx/R8fBgYsytAeca2lpSKW+6I=")
nl.loginResult()
