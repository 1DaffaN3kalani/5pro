...
def bot(op):
  ...
  #-----------------=Selesai=------------------
              ...
              if msg.from_ in owner:
                ...
                if wait["Wc"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"noтιғ Greet joιn on")
                else:
                    wait["Wc"] = True
                    if wait["lang"] == "JP":
                ...
                if wait["Wc"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"noтιғ Greet joιn oғғ")
                else:
                    wait["Wc"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already oғғ")
            elif msg.text in ["Gogreet on"]:
                if wait["Lv"] == True:
                    if wait["lang"] == "JP":
...
#---------------------
        if op.type == 17:
           if wait["Wc"] == True:
              ...
              gm = Message()
              gm.to = op.param1
              gm.text = ("╔═════════════" + "\n║" + cl.getContact(op.param2).displayName + "\n╠═════════════\n║[🙋 WELCOME TO THE GROUP 🙋] " + str(ginfo.name) + "\n╠═════════════\n" + "║FOUNDER👉 " + str(ginfo.name) + " :\n║" + ginfo.creator.displayName + "\n╠═════════════\n" + "║😊Semoga Betah Kak 😘 \n╠═════════════\n║No Baper,No nakal,No Anu..ya!! \n╚═════════════")
              cl.sendMessage(gm)
