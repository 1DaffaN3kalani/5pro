...
owner=["u0f4cbccff2b03754d07d8db8707023f6","u00ec612f74d8380efb14472e6f11eec9"]
whitelist=[""]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                ...
                wait["greet"] = True
                cl.sendText(msg.to,"Greet Sudah Aktif") 
            elif msg.text in ["Greet off"]:
                wait["greet"] = False
                cl.sendText(msg.to,"Greet Di Nonaktifkan")
