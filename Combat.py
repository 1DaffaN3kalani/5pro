...
cl.login(token="Eopt3f9lHVUicT7damJc.y+2srPC7vfACLUdN4E1uda.uFIP3mO23GdlqNvhm/iSczzovNP2wdPPF6gKMaBsQAg=")
cl.loginResult()

ki = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-10☪ইद 􀂳􏿿
ki.login(token="EoVzHOMYIhko5QR0Z6O9.ZKUHmn7A7fy0TpGtw0PFQq.Svc7aK3BpIYtcf5AiY4Goto7hMMz1sbfcsQ85mx2zpo=")
ki.loginResult()

kk = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-11☪ইद 􀂳􏿿
kk.login(token="EoTgd7nANPmF7Rv7qyv1.cnCKeS8mJyEU5JSZppFleq.cZFbzld/wrX1+yNVQpvyQODYEOClEzu+6jdVzYzIbeA=")
kk.loginResult()

kc = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-012☪ইद 􀂳􏿿
kc.login(token="Eo6pcEZ2XZagEAnL0GD3.L9pMQX2GdfKTYct2VR4V8W.sn8y6hiTFNip72ymBi9JFs4ebJGwfm5soU+9ilDbDV4=")
kc.loginResult()

ks = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-13☪ইद 􀂳􏿿
ks.login(token="EoTgd7nANPmF7Rv7qyv1.cnCKeS8mJyEU5JSZppFleq.cZFbzld/wrX1+yNVQpvyQODYEOClEzu+6jdVzYzIbeA=")
ks.loginResult()

ka = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-14☪ইद 􀂳􏿿
ka.login(token="EokLZi646ykBAqwuuzk3.+uLPvUiSMYLprcBKBSaDiW.pWSrF2Kqo553sRe2Z8oeYz/5jHM2d+dY8pjTNi0YV9Q=")
ka.loginResult()

#nl = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-Backup1☪ইद 􀂳􏿿
#nl.login(token="EonDRkxZthYZ41Z4NcT1.fs2cgHLX6TOYCA89m8LcSq.xTIHylhstn16WbvmMLVhlQccSyv7N2Hl3pne3L+fU20=")
#nl.loginResult()

#nl1 = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-Backup2☪ইद 􀂳􏿿
#nl1.login(token="EonDRkxZthYZ41Z4NcT1.fs2cgHLX6TOYCA89m8LcSq.xTIHylhstn16WbvmMLVhlQccSyv7N2Hl3pne3L+fU20=")
#nl1.loginResult()
...
Amid = ki.getProfile().mid#數]KR-10☪ইद 􀂳􏿿
Bmid = kk.getProfile().mid#數]KR-11☪ইद 􀂳􏿿
Cmid = kc.getProfile().mid#數]KR-12☪ইद 􀂳􏿿
Dmid = ks.getProfile().mid#數]KR-13☪ইद 􀂳􏿿
Emid = ka.getProfile().mid#數]KR-14☪ইद 􀂳􏿿
...
admin=["u0f4cbccff2b03754d07d8db8707023f6","u152d821a1971eada3271af3d33c942b1","u8b0786be72edafd53a9ce1a693e834b2","u49f0e82e090055efa3a43330be526467","uf02095b6bf0084b3a5c8233ce91ce279","ua4a9274ad60ab9c1df538af091db67d3","u91a4a70e482509d4cdf1ce4ed7498bc4"] 
