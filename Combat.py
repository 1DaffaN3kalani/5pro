...
cl.login(token="EozlKSPl22UcSObvw0N3.PkKNsTykUChFu4RWKDTN0W.0SmLe0IEpqHsmdNWBg6lFVT5g7JsLZRL9YwW3XSExfA=")
cl.loginResult()
...
ka.login(token="EoH6XisVR40syMB9cVT9.8ccvTR8aHloLYcm86rZIEq.m+9YWImCpLYFCxUe0s9Z4Ww4XF5rtokT2BF0SE/UzXA=")
ka.loginResult()
...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"THANKS FOR ADD ME SORRY I AM JUST BOT",
    "lang":"JP",
    "comment":"",
    "commentOn":True,
    "commentBlack":{},
        ...
        if op.type == 26:
           ...
           if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pm Aja","DaffaNya lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
