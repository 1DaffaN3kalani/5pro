...
#---------------------Sc invite owner ke group------
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye KR","Get out","Bye bye","Bye KR1]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"すでに保護している86It's Present KR1-T34M Ready To Protect Group Bebs😘😘😘💋💋")
