...
cl.login(token="EopCg7TDzLlKv4DpOl71.fs2cgHLX6TOYCA89m8LcSq./akagz5JQQ9HmD31GEgDXQMegkt3tpCvghhge5VF+zs=")
cl.loginResult()

ki = LINETCR.LINE() #TwoBot
ki.login(token="EoZDxyUY25htVfhfKqp2.IWEgVNlTR9u6NogMK/G0SG.LZdjm8oyoCLlS2qtQ30m0en0zSyio91A5ccNuDAKwEU=")
ki.loginResult()

kk = LINETCR.LINE() #TreeBot
kk.login(token="EoAnG3ydC2dmQGiskla7.sFdOlGKavE/JPdmWVLjKzW.fTIozbNoXXc6DRoUK8/pDeyWZ7D6iih9KtUVDF5qaWQ=")
kk.loginResult()

kc = LINETCR.LINE() #FourBot
kc.login(token="EovJXJA1MmWDedenkSI9.8ccvTR8aHloLYcm86rZIEq.sQOHnm4jn8m0BYz5YR46pfIgSGAyiUtGr9FTJOoTiuQ=")
kc.loginResult()

ks = LINETCR.LINE() #FiveBot
ks.login(token="Eoqf6kxXfg69fUTMzx73.PkKNsTykUChFu4RWKDTN0W.l9aZNbFCwSEdQRcViuiL4sZFZWMOQPiDTl+hOBgVUjw")
ks.loginResult()

ka = LINETCR.LINE() #SixBot
ka.login(token="EofW7x6VlGDX4HPKZxm4.KAsNdKGLcDtn8C5o10MlXa.mN39MyyJwE2nC6AiGFKvTcxkPMR2KCVj0ugNASKx9PM=")
ka.loginResult()
...
admin=["u0f4cbccff2b03754d07d8db8707023f6","u7341e12330207e4e2425341323bb9c46","u152d821a1971eada3271af3d33c942b1","u577d79f51412f92e7a28d360ca351ae4"] 
...
#---------------------Sc invite owner ke group------
        ...
        #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["In2","Come2","Oyyy2","Come"]:
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye2","Get out2","Out2","Bye"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Absen bot","Team","Respon"]:
              if msg.from_ in admin:
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
            return
          random.choice(KAC).sendText(op.param1, "Inalliahiwainalilahirojiun Kenapa Tuh Leave???\nBaper Kayaknya cuma Dumay aja Coyyyy😜😜😜")
