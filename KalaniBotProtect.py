...
cl.login(token="Eo1ewf5lPXXtD5rzZaD1.fs2cgHLX6TOYCA89m8LcSq.rWOMJwJN6cVCvtqIKjA7riZR6CfD29OZTSLF5O2u/Xc=")
cl.loginResult()

ki = LINETCR.LINE() #TwoBot
ki.login(token="EoWQm9lgiqfYRwEbuT12.IWEgVNlTR9u6NogMK/G0SG.Y2Q8k8t60V2EGK5UUgaWPTR8XRYqfBJ4BWq9kWuU7lE=")
ki.loginResult()

kk = LINETCR.LINE() #TreeBot
kk.login(token="EojaFL8HiGg5AGO4gXL7.sFdOlGKavE/JPdmWVLjKzW.cZm9yB1meXzVQWdDokU5jB4R2C1wrqRbTXmn6V7GNwg=")
kk.loginResult()

kc = LINETCR.LINE() #FourBot
kc.login(token="EoQUfS1SKLkINIoeneY9.8ccvTR8aHloLYcm86rZIEq.iQ1mOGZrfuOyGcvqzkQURineo8JIFRdNIZZ0coTicCc=")
kc.loginResult()

ks = LINETCR.LINE() #FiveBot
ks.login(token="EortyIgvBy1qc0L5JsI3.PkKNsTykUChFu4RWKDTN0W.T4P+474911T1Prjsxsu8WTjnUxTm9RdHFP5jrQg6ZsA=")
ks.loginResult()

ka = LINETCR.LINE() #SixBot
ka.login(token="EoTkChEXtzn7R84zabz4.KAsNdKGLcDtn8C5o10MlXa.I8D9BkoxNE+b2Fa4JmmLL1psJq5B1BUkcWlyTUeQFGk=")
ka.loginResult()
