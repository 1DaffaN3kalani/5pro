...
cl = LINETCR.LINE() #OneBot
cl.login(token="EoMX2xL7FRYYTbv8vbQ1.fs2cgHLX6TOYCA89m8LcSq.feFMBRk0GbPBvoCSjZabu6s9bojelnj4WbYfOP2bsE4=")
cl.loginResult()

ki = LINETCR.LINE() #TwoBot
ki.login(token="EoFYY6aYG8HzoEpwWw82.IWEgVNlTR9u6NogMK/G0SG.DV8x0eWWCPCgp4j9cSUrdKaQOkRl6arv9Z0EKKWNmu0=")
ki.loginResult()

kk = LINETCR.LINE() #TreeBot
kk.login(token="EoMuCBQSU7TSZEWx2ar7.sFdOlGKavE/JPdmWVLjKzW.r/rIBfgYh6HN1aK5NYmRzmnWqkQcsPHU+7U0S5Gvui8=")
kk.loginResult()

kc = LINETCR.LINE() #FourBot
kc.login(token="EoPw5wpzBbIuY80uEHi9.8ccvTR8aHloLYcm86rZIEq.qrhXzJwx0cCQRgZZkU8fUcXK158gtjRvGysyTmf/VLk=")
kc.loginResult()

ks = LINETCR.LINE() #FiveBot
ks.login(token="Eou93JBCW8S93TcdhXI3.PkKNsTykUChFu4RWKDTN0W.RQK34GzHwvkAFX8woBq5F4XR6SNMu6pWxpRMn1akGcE=")
ks.loginResult()

ka = LINETCR.LINE() #SixBot
ka.login(token="Eo5vk3ev27AElk7IQ4x4.KAsNdKGLcDtn8C5o10MlXa.MibXqkPsA8q1u2mSsWzG6KtZIEmMwYsACZJjwNAwcOw=")
ka.loginResult()
...
admin=["u0f4cbccff2b03754d07d8db8707023f6","u7341e12330207e4e2425341323bb9c46","u05b001551c897ad6a6e2ca6cecccd32e","u577d79f51412f92e7a28d360ca351ae4","u00ec612f74d8380efb14472e6f11eec9"] 
owner=["u0f4cbccff2b03754d07d8db8707023f6","u577d79f51412f92e7a28d360ca351ae4","u00ec612f74d8380efb14472e6f11eec9"]
...
#---------------------Sc invite owner ke group------
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Get out","Bye bye"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to,"すでに保護している86It's Present Ready To Protect Group Bebs😘😘😘💋💋")
