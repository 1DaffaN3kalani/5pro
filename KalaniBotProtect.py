...
cl.login(token="EoUpP5cDIre57Edz5GT1.fs2cgHLX6TOYCA89m8LcSq.XzpyyhY6chmlngWwlBqZ347DS48JTcuFaTZp4B2BW2s=")
cl.loginResult()

ki = LINETCR.LINE() #TwoBot
ki.login(token="EoNe0WpZTXH5EmbxDOF2.IWEgVNlTR9u6NogMK/G0SG.MMsCUatLcQXo+rKNk8ThEHFRbHqJ0R7rLbiIYOZ91Eg=")
ki.loginResult()

kk = LINETCR.LINE() #TreeBot
kk.login(token="EovYop5neotYSQanOY47.sFdOlGKavE/JPdmWVLjKzW.7CHtLj9dt25xwqCnaQ4AdmExhQp71ma35y5HVk9fpow=")
kk.loginResult()

kc = LINETCR.LINE() #FourBot
kc.login(token="EovYEjPUyCcyC50wGno9.8ccvTR8aHloLYcm86rZIEq.Tl6vtgcMOPLHGald4fQhX1d9l6Hk/txuH9nlOTlmsfs=")
kc.loginResult()

ks = LINETCR.LINE() #FiveBot
ks.login(token="EopLduDd8V7XAk8UxZf3.PkKNsTykUChFu4RWKDTN0W.dXvx55KieRVK/CeIWRebkzlbY8kLcU2fM3yeQfogvKE=")
ks.loginResult()

ka = LINETCR.LINE() #SixBot
ka.login(token="Eosp2RiHEYVcBbWRAeu4.KAsNdKGLcDtn8C5o10MlXa.BtAfzBKngFN+7C6fMbGWfWgIN86fww+5O6nnpIvEWKk=")
ka.loginResult()
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
            return
          random.choice(KAC).sendText(op.param1, "Heemmmm.... Bye..Bye...kakak🙋🙋🙋...Sampai jumpa kembali...Salam Cipokk😘😘😘💋💋💋")
