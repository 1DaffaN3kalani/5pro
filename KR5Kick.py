...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,mid1,mid2,mi3]
admin = [mid,Amid,Bmid,Cmid,Dmid,Emid,mid1,mid2,mi3]
owner = [mid]
wait = {
    'contact':False,
    'autoJoin':True,
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = mid,Amid,Bmid,Cmid,Dmid,Emid,mid1,mid2,mi3
			if op.param2 in Bots and admin:
				pass
			else:
				Inviter = op.param3.replace("",',')
