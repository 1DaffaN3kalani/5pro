...
cl = LINETCR.LINE()
cl.login(token="Eo6i8UxX7rhwMZF408n8.fjSIf69Wywe4OCILM+Z4Qa.jkVSx044yx4AfAsN0rGpQby/6GvNVoSnQ1QAsPJqwlY=")
cl.loginResult()
    ...
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["\nR4D1ST1 Lagi Off Ngurusi Sumiran Jangan Tag Tag Mulu Sampluk Purun "]
                     ret_ = "[Woyyy Iyoo!!!] " + random.choice(balas)
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy",cName + " Ngapain Ngetag?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pm Aja","R4D15T1nya lagi off", cName + " Kenapa Tag saya?","SPAM PC aja " + cName, "Jangan Suka Tag gua " + cName, "Kamu siapa " + cName + "?", "Ada Perlu apa " + cName + "?","Tenggelamkan tuh yang suka tag pake BOT","Tersummon -_-"]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u149b2217af70616138a1c8a59bfcf8a8',"}
                cl.sendMessage(msg)
