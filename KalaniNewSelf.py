...
cl.login(token="EnRiQjZ3n5dL42krIkM6.d0Y8Z+kWn1tqFy24ChaJ9G.E8IdA+BTVEuzFytzI1aTJr7E3GDcFwfB3R65FWR0Cpk=")
cl.loginResult()

ki = LINETCR.LINE() #One
ki.login(token="EnNi4XiB3CYH5O9mIyz1.fs2cgHLX6TOYCA89m8LcSq.jpHfAQyTImok4QTPsrDxjBG827mV1YySdoBi+b+L1dM=")
ki.loginResult()

kk = LINETCR.LINE() #Two
kk.login(token="Eny8uk9M7BmYUnTh41T7.sFdOlGKavE/JPdmWVLjKzW.GO0FEA1X/UeGQhKsgNnG4VVI/gdoYzdJkx/NdUQYxG4=")
kk.loginResult()

kc = LINETCR.LINE() #Tree
kc.login(token="EnMta0kmcmmVUf9Fybz3.PkKNsTykUChFu4RWKDTN0W.TSwdWWK21Hx/MiFqzcjCnKj7OHpDCQyX+Q1aosKL3KI=")
kc.loginResult()

ks = LINETCR.LINE() #Four
ks.login(token="En542vnRQHvpZaSpyii9.8ccvTR8aHloLYcm86rZIEq.YkBhuIzJYZyG5lmKErwkVNmsouEEZJsZNZsZETw5ki4=")
ks.loginResult()

ka = LINETCR.LINE() #Five
ka.login(token="EnavGAHbjP6G6l0nXcc2.IWEgVNlTR9u6NogMK/G0SG.ZcdQVAFTyD+MzewMUVOtT6pOvfFlQNLSG75BI1QG78g=")
ka.loginResult()
...
admin=["u0f4cbccff2b03754d07d8db8707023f6","u7341e12330207e4e2425341323bb9c46","u82f7bb98715417c34fe1b7fac263e893"] 
...
CONTACT:
Idline: http://line.me/ti/p/H2VZm0LFeR~ই✠☪1DaffaN3Kalani☪ইद""",
    "lang":"JP",
    "comment":"Thanks for add Me By : ই✠☪1DaffaN3Kalani☪ইद\n\nhttp://line.me/ti/p/H2VZm0LFeR",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
def bot(op):
          ...
          if wait["Protectgr"] == True:
            if cl.getGroup(op.param1).preventJoinByTicket == False:
              if op.param2 in Bots:
                ...
                try:
                  ki.sendText(op.param1,ki.getContact(op.param2).displayName + "Wooyyy Please Dont Playing Link Group BROO!!!")
                  ...
                  ki.updateGroup(H)
                  ki.sendText(op.param1,ki.getContact(op.param2).displayName + "\n" + "Added Into Blacklist Done✔")
                  wait["blacklist"][op.param2] = True
                  f=codecs.open('st2__b.json','w','utf-8')
                  json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                except:
                  #random.choice(KAC).sendText(op.param1,random.choice(KAC).getContact(op.param2).displayName + "Wooyyyy Please Don't Playing Link QR Group Brooo!!!")
  ...
  #------Joined User Kick start------#
      ...
      #---------------                      
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                  ...
                  if targets == []:
                    ...
                    for target in targets:
                      try:
                        ...
                        ka.sendText(msg.to,"Already Invited 💋: \n➡" + _name)
                        wait["winvite6"] = False
                        break
                      except:
                        try:
              ...
              if msg.from_ in owner:
                midd = msg.text.replace("Twonvite ","")
    ...
    #--------------- SC Add Admin ---------
              ...
              if msg.from_ in owner:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin Already Deleted Done✔")
                        except:
                            pass
              ...
              if admin == []:
                  ...
                  ki.sendText(msg.to,"Wait...Bebs😘😘😘")
                  mc = "👑 ST4FF 124D15T1 T34M 👑\n𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓\n"
                  for mi_d in admin:
              ...
              if owner == []:
                  ki.sendText(msg.to,"The Owner is empty")
              else:
                  cl.sendText(msg.to,"Wait...Bebs😘😘😘")
                  mc = "👑 124D15T1 T34M PROTECT 👑\n𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓\n"
                  for mi_d in owner:
                      mc += "[★]" + cl.getContact(mi_d).displayName + "\n"
                  ki.sendText(msg.to,mc)
  ...
  #-----------------=Selesai=------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["One open qr","One buka qr"]:
              if msg.from_ in owner:
                if msg.toType == 2:
            ...
            elif msg.text in ["Highpro on","Purge on","Purge: on","purge: on"]:
              if msg.from_ in admin:
                if wait["Protectjoin"] == True:
                    if wait["lang"] == "JP":
              ...
              if msg.from_ in owner:
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid By Share Kontak On✔")
                    else:
                        cl.sendText(msg.to,"Done")
                else:
                    wait["contact"] = True
              ...
              if msg.from_ in owner:
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid By Share Kontak Off✔")
                    else:
                        cl.sendText(msg.to,"Done✔")
                else:
                    wait["contact"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cek Mid By Kontak Off✔")
                    else:
                        cl.sendText(msg.to,"done")
...
#---------------------Sc invite owner ke group------
        ...
        #-------------Fungsi Jam Update Finish-------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to, "Checking Point...")
                try:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Bye","Get out","Out"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Start---------------#
            elif msg.text in ["Assalamualaikum.","Tagall","Hello"]:
            	 if msg.from_ in admin:
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"We are ready like Owner status we Love & like U Bebs😘😘😘")
                try:
                  likePost()
                except:
                  pass
              ...
              if msg.from_ in owner:
                print "[Command]Like executed"
                cl.sendText(msg.to,"We are ready like friends status😘😘😘")
                try:
                  autolike()
                  cl.sendText(msg.to,"Already Like Bebs😘😘😘")
                except:
                  pass
        #----------------Fungsi Banned Kick Target Start-----------------------#
              ...
              if msg.from_ in owner:
    	          cl.sendText(msg.to, "We are ready to restart Bot\nRestart Time Please wait about 10Seconds😘😘😘 ")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                random.choice(KAC).sendText(msg.to,"Succes Banned Boss Bebs😘😘")
                            except:
        ...
        #----------------Fungsi Unbanned User Target Finish-----------------------#
                ...
                if targets == []:
                  ...
                  for target in targets:
                    try:
                      ...
                      cl.sendText(msg.to, "Success Copy profile Done✔")
            ...
            elif "Replay " in msg.text:
              if msg.from_ in owner:
                bctxt = msg.text.replace("Replay ", "")
      ...
      #--------------Fungsi Broadcast Finish-----------#
            ...
            elif msg.text in ["LG","List Group","Glist"]:
              if msg.from_ in owner:
      ...
      #--------------List Group------------
       #------------ Keluar Dari Semua Group------
            elif msg.text in ["Bot all out","Bye all out"]:
              if msg.from_ in owner:
                #gid = cl.getGroupIdsJoined()
                gid = ki.getGroupIdsJoined()
                gid = kk.getGroupIdsJoined()
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Absen","Stay","Radisti","Respon86"]:
              if msg.from_ in admin:
                ...
                ki.sendText(msg.to,"フランキー It's Present Done✔Complete\nReady To Protect Group")
    #-------------Fungsi Respon Finish---------------------#   
              ...
              if msg.from_ in owner:
                wait["winvite6"] = True
                ka.sendText(msg.to,"Please Share contact your friends Bebs 😘😘😘")
                
            elif msg.text in ["Invite Gcreator","Invite gcreator"]:
              if msg.from_ in owner:
                if msg.toType == 2:
                  ginfo = cl.getGroup(msg.to)
      ...
      #-------------Fungsi Banned Send Contact Start------------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"Please Send Contact Boss Bebs😘😘")
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
            ...
            elif msg.text in ["Daffa","Woy","woy","Woi","woi","bot","Bot"]:
              quote = ['Apaan sih Ka Kurang Kerjaan Banget','Bodo Amat','Dasar Jones Manggil² Bot','Jones Ya?','Ada Orang kah disini?','Ah Apaan sihhh','Ayo ngopi Coy?']
                  ...
                  if targets == []:
                      ...
                      for target in targets:
                          try:
                              ...
                              cl.updateProfile(profile)
                              cl.sendText(msg.to,"Steal Profile Picture Success Done✔ 😂")
                          except Exception as e:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By : 124D15T1 T34M B0T\nStatus Boss udah Kami Like\nOwner Kami :\nই✠☪1DaffaN3Kalani☪ইद")
                    print "Like"
                except:
                    pass
            else:
