...
#---------------------Sc invite owner ke group------
    ...
    #-------------Fungsi Tag All Finish---------------#
              ...
              if msg.from_ in owner:
                ...
                cl.sendText(msg.to,"We are ready like Owner status Love U Bebs😘😘😘")
                try:
                  likePost()
                except:
                  pass
        ...
        #----------------Fungsi Banned Kick Target Start-----------------------#
              ...
              if msg.from_ in owner:
    	          cl.sendText(msg.to, " We are ready to restart Bot Restart\nTime wait about 10Seconds😘😘😘 ")
