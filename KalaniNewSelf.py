...
cl.login(token="Eoe65VUM4Yfl6oBbWhh6.d0Y8Z+kWn1tqFy24ChaJ9G.B9bw/+amGpQL/o0ZpHye8JnWzIrOWULSnKkoMMS+7B0=")
cl.loginResult()

ki = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-10☪ইद 􀂳􏿿
ki.login(token="EoL0NOIubBPzM8wdZy79.ZKUHmn7A7fy0TpGtw0PFQq.3kb2fckBWA5Ol328JJ+t4FqEGuAgV7LYFmln75bTQMw=")
ki.loginResult()

kk = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-11☪ইद 􀂳􏿿
kk.login(token="EoeeQ5R5PkOIMgpl4Z61.cnCKeS8mJyEU5JSZppFleq.WYXH859rw6naZyMuAU6TruY/EsAPY2quvx1/ahUis98=")
kk.loginResult()

kc = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-012☪ইद 􀂳􏿿
kc.login(token="EoeeQ5R5PkOIMgpl4Z61.cnCKeS8mJyEU5JSZppFleq.WYXH859rw6naZyMuAU6TruY/EsAPY2quvx1/ahUis98=")
kc.loginResult()

ks = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-13☪ইद 􀂳􏿿
ks.login(token="EoWeLZYgdpWlH6w7oOV3.L9pMQX2GdfKTYct2VR4V8W.dnQam0+4Cu2q+JnkH+RHLIaYthFdsgqSXV2m9FH9FGU=")
ks.loginResult()

ka = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-14☪ইद 􀂳􏿿
ka.login(token="EoWeLZYgdpWlH6w7oOV3.L9pMQX2GdfKTYct2VR4V8W.dnQam0+4Cu2q+JnkH+RHLIaYthFdsgqSXV2m9FH9FGU=")
ka.loginResult()

k1 = LINETCR.LINE() #􀰂􀰂􀰂􀰂[數]KR-Backup☪ইद 􀂳􏿿
k1.login(token="EoCz72UwxDqmm3PLP7gc.y+2srPC7vfACLUdN4E1uda.LvUBqgCEJbsuGfj18WPNBc6AszFcaN8qxLxXdSGThXk=")
k1.loginResult()
      ...
      #---------------                      
        ...
        if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Don't Tag Me! iam Bussy!, ",cName + "ya ada apa, ?",cName + " Pm aja klo urgent! sedang sibuk,", " Iya kenapa, ", cName + " kangen?","kangen bilang gausa tag tag, " + cName, "knp?, " + cName, "apasi?, " + cName + "?", "pulang gih, " + cName + "?","aya naon, ?" + cName + "Tersummon -_-"]
