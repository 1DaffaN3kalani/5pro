...
#􀰂􀰂􀰂􀰂[數]Kalani☪ইद 􀂳􏿿
cl = LINETCR.LINE()
cl.login(token="EoKpdTq6i49G5Ez6gTB6.d0Y8Z+kWn1tqFy24ChaJ9G.ADPgQzJlFWsRXGfcMLr02FoYZIvB4p3II8YY5GpXjLQ=")
cl.loginResult()
#􀰂􀰂􀰂􀰂[數]KR-01☪ইद
ki = LINETCR.LINE()
...
#􀰂􀰂􀰂􀰂[數]KR-05☪ইद
kt = LINETCR.LINE()
kt.login(token="EozlKSPl22UcSObvw0N3.PkKNsTykUChFu4RWKDTN0W.0SmLe0IEpqHsmdNWBg6lFVT5g7JsLZRL9YwW3XSExfA=")
kt.loginResult()
#Kicker-01#
kl = LINETCR.LINE()
kl.login(token="EohHhbQ82JhqVVVtFC2b.9IDiOnQCFrq8VP+5C4CgMW.Db2Rwq02olzERHx3Yr9qwVWT1VOYzniS+WnZZR2gti8=")
kl.loginResult()
#Kicker-02#
kl1 = LINETCR.LINE()
kl1.login(token="EoUca6vxd4uz0WqcyOk1.nqiomoBQHvZwTghGAbvWyq.Ovh8PgJgAROpuB9hSdynW8RzbFn8HPKH98+j+z1s0v0=")
kl1.loginResult()
#Kicker-03#
kl2 = LINETCR.LINE()
kl2.login(token="Eo3rMNW8WZE0gJoVXU26.q3uM03cLP1Ka+2slGGx0DG.Xv6vWvwcyARhZN5Jaf4LBESbFF3Ykm1VQ3VXir4/gEs=")
kl2.loginResult()
...
●▬▬▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬▬●
"""
KAC=[cl,ki,kk,kc,ks,kt,kl,kl1,kl2]
KAB=[ki,kk,kc,ks,kt]
Kicker=[kl,kl1,kl2]
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,mid1,mid2,mid3]
admin = [mid,Amid,Bmid,Cmid,Dmid,Emid,mid1,mid2,mid3]
owner = [mid]
wait = {
    'contact':False,
    'autoJoin':True,
